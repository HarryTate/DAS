    ...
    <div class="carousel-inner">
      <div class="item active">
        ...
        <div class="carousel-caption">
          <h3>About Us</h3>
          <p>Find out about our company</p>
        </div>
      </div>

      <div class="item">
        <img src="images/jumbotron2.jpg" alt="Chicago" style="width:100%;">
        <div class="carousel-caption">
          <h3>Our Services</h3>
          <p>See what services we have to offer</p>

        </div>
      </div>

      <div class="item">
        <img src="images/jumbotron3.jpg" alt="New York" style="width:100%;">
        <div class="carousel-caption">
          <h3>Contact Us</h3>
          <p>View  our contact details</p>
        </div>
      </div>
